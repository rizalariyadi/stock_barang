...
//get data 
//ambil data total
$get = mysqli_query($conn,"select * from retur");
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                             ...
                             <a href="exportretur.php" class="btn btn-success">Export Data<a/>  
                             <br>
                             <div class="row mt-4">
                                     <div class=" card text-primary"> <h2>Total Data: <?=$count;?></h2></div>
                             </div>
                             <!-- belom selesai filter tanggal 
                                <div class="row mb-4">
                                    <div class="cel">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        $ambilsemuadatastock = mysqli_query($conn,"select * from retur m, stock s where s.idbarang = m.idbarang");
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
        ...
        <br>
        <button type="submit" class="btn btn-primary" name="barangretur">Submit</button>
        </div>
        </form>
    </div>
  </div>
